    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'vox_nav_msgs.action.NavigateThroughPoses_Goal')
            logger.debug(
...
class Metaclass_NavigateThroughPoses_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'vox_nav_msgs.action.NavigateThroughPoses_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_NavigateThroughPoses_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'vox_nav_msgs.action.NavigateThroughPoses_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_NavigateThroughPoses_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from vox_nav_msgs.action import NavigateThroughPoses
...
class NavigateThroughPoses_SendGoal_Request(metaclass=Metaclass_NavigateThroughPoses_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'vox_nav_msgs/NavigateThroughPoses_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['vox_nav_msgs', 'action'], 'NavigateThroughPoses_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from vox_nav_msgs.action._navigate_through_poses import NavigateThroughPoses_Goal
...
class Metaclass_NavigateThroughPoses_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'vox_nav_msgs.action.NavigateThroughPoses_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from vox_nav_msgs.action import _navigate_through_poses
...
class NavigateThroughPoses_SendGoal(metaclass=Metaclass_NavigateThroughPoses_SendGoal):
    from vox_nav_msgs.action._navigate_through_poses import NavigateThroughPoses_SendGoal_Request as Request
    from vox_nav_msgs.action._navigate_through_poses import NavigateThroughPoses_SendGoal_Response as Response
...
class NavigateThroughPoses_GetResult_Response(metaclass=Metaclass_NavigateThroughPoses_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'vox_nav_msgs/NavigateThroughPoses_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['vox_nav_msgs', 'action'], 'NavigateThroughPoses_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from vox_nav_msgs.action._navigate_through_poses import NavigateThroughPoses_Result
...
class Metaclass_NavigateThroughPoses_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'vox_nav_msgs.action.NavigateThroughPoses_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class NavigateThroughPoses_GetResult(metaclass=Metaclass_NavigateThroughPoses_GetResult):
    from vox_nav_msgs.action._navigate_through_poses import NavigateThroughPoses_GetResult_Request as Request
    from vox_nav_msgs.action._navigate_through_poses import NavigateThroughPoses_GetResult_Response as Response
...
class Metaclass_NavigateThroughPoses_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'vox_nav_msgs.action.NavigateThroughPoses_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class NavigateThroughPoses_FeedbackMessage(metaclass=Metaclass_NavigateThroughPoses_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'vox_nav_msgs/NavigateThroughPoses_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['vox_nav_msgs', 'action'], 'NavigateThroughPoses_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from vox_nav_msgs.action._navigate_through_poses import NavigateThroughPoses_Feedback
...
class Metaclass_NavigateThroughPoses(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'vox_nav_msgs.action.NavigateThroughPoses')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class NavigateThroughPoses(metaclass=Metaclass_NavigateThroughPoses):
    ...
    from vox_nav_msgs.action._navigate_through_poses import NavigateThroughPoses_Goal as Goal
    # The result message defined in the action definition.
    from vox_nav_msgs.action._navigate_through_poses import NavigateThroughPoses_Result as Result
    # The feedback message defined in the action definition.
    from vox_nav_msgs.action._navigate_through_poses import NavigateThroughPoses_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from vox_nav_msgs.action._navigate_through_poses import NavigateThroughPoses_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from vox_nav_msgs.action._navigate_through_poses import NavigateThroughPoses_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from vox_nav_msgs.action._navigate_through_poses import NavigateThroughPoses_FeedbackMessage as FeedbackMessage
