  ...
  vox_nav_msgs__action__NavigateToPose_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    vox_nav_msgs__action__NavigateToPose_Goal * data =
      (vox_nav_msgs__action__NavigateToPose_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!vox_nav_msgs__action__NavigateToPose_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          vox_nav_msgs__action__NavigateToPose_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  vox_nav_msgs__action__NavigateToPose_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    vox_nav_msgs__action__NavigateToPose_Result * data =
      (vox_nav_msgs__action__NavigateToPose_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!vox_nav_msgs__action__NavigateToPose_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          vox_nav_msgs__action__NavigateToPose_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  vox_nav_msgs__action__NavigateToPose_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    vox_nav_msgs__action__NavigateToPose_Feedback * data =
      (vox_nav_msgs__action__NavigateToPose_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!vox_nav_msgs__action__NavigateToPose_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          vox_nav_msgs__action__NavigateToPose_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  vox_nav_msgs__action__NavigateToPose_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    vox_nav_msgs__action__NavigateToPose_SendGoal_Request * data =
      (vox_nav_msgs__action__NavigateToPose_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!vox_nav_msgs__action__NavigateToPose_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          vox_nav_msgs__action__NavigateToPose_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  vox_nav_msgs__action__NavigateToPose_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    vox_nav_msgs__action__NavigateToPose_SendGoal_Response * data =
      (vox_nav_msgs__action__NavigateToPose_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!vox_nav_msgs__action__NavigateToPose_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          vox_nav_msgs__action__NavigateToPose_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  vox_nav_msgs__action__NavigateToPose_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    vox_nav_msgs__action__NavigateToPose_GetResult_Request * data =
      (vox_nav_msgs__action__NavigateToPose_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!vox_nav_msgs__action__NavigateToPose_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          vox_nav_msgs__action__NavigateToPose_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  vox_nav_msgs__action__NavigateToPose_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    vox_nav_msgs__action__NavigateToPose_GetResult_Response * data =
      (vox_nav_msgs__action__NavigateToPose_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!vox_nav_msgs__action__NavigateToPose_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          vox_nav_msgs__action__NavigateToPose_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  vox_nav_msgs__action__NavigateToPose_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    vox_nav_msgs__action__NavigateToPose_FeedbackMessage * data =
      (vox_nav_msgs__action__NavigateToPose_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!vox_nav_msgs__action__NavigateToPose_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          vox_nav_msgs__action__NavigateToPose_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
