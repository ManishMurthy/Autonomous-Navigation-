  ...
  vox_nav_msgs__action__FollowPath_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    vox_nav_msgs__action__FollowPath_Goal * data =
      (vox_nav_msgs__action__FollowPath_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!vox_nav_msgs__action__FollowPath_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          vox_nav_msgs__action__FollowPath_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  vox_nav_msgs__action__FollowPath_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    vox_nav_msgs__action__FollowPath_Result * data =
      (vox_nav_msgs__action__FollowPath_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!vox_nav_msgs__action__FollowPath_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          vox_nav_msgs__action__FollowPath_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  vox_nav_msgs__action__FollowPath_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    vox_nav_msgs__action__FollowPath_Feedback * data =
      (vox_nav_msgs__action__FollowPath_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!vox_nav_msgs__action__FollowPath_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          vox_nav_msgs__action__FollowPath_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  vox_nav_msgs__action__FollowPath_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    vox_nav_msgs__action__FollowPath_SendGoal_Request * data =
      (vox_nav_msgs__action__FollowPath_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!vox_nav_msgs__action__FollowPath_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          vox_nav_msgs__action__FollowPath_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  vox_nav_msgs__action__FollowPath_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    vox_nav_msgs__action__FollowPath_SendGoal_Response * data =
      (vox_nav_msgs__action__FollowPath_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!vox_nav_msgs__action__FollowPath_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          vox_nav_msgs__action__FollowPath_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  vox_nav_msgs__action__FollowPath_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    vox_nav_msgs__action__FollowPath_GetResult_Request * data =
      (vox_nav_msgs__action__FollowPath_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!vox_nav_msgs__action__FollowPath_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          vox_nav_msgs__action__FollowPath_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  vox_nav_msgs__action__FollowPath_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    vox_nav_msgs__action__FollowPath_GetResult_Response * data =
      (vox_nav_msgs__action__FollowPath_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!vox_nav_msgs__action__FollowPath_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          vox_nav_msgs__action__FollowPath_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  vox_nav_msgs__action__FollowPath_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    vox_nav_msgs__action__FollowPath_FeedbackMessage * data =
      (vox_nav_msgs__action__FollowPath_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!vox_nav_msgs__action__FollowPath_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          vox_nav_msgs__action__FollowPath_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
