  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vox_nav_msgs__action__ComputePathToPose_Goal;
    is_plain =
      (
...
static size_t _ComputePathToPose_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vox_nav_msgs__action__ComputePathToPose_Goal(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = vox_nav_msgs__action__ComputePathToPose_Result;
    is_plain =
      (
...
static size_t _ComputePathToPose_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vox_nav_msgs__action__ComputePathToPose_Result(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = vox_nav_msgs__action__ComputePathToPose_Feedback;
    is_plain =
      (
...
static size_t _ComputePathToPose_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vox_nav_msgs__action__ComputePathToPose_Feedback(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = vox_nav_msgs__action__ComputePathToPose_SendGoal_Request;
    is_plain =
      (
...
static size_t _ComputePathToPose_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vox_nav_msgs__action__ComputePathToPose_SendGoal_Request(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = vox_nav_msgs__action__ComputePathToPose_SendGoal_Response;
    is_plain =
      (
...
static size_t _ComputePathToPose_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vox_nav_msgs__action__ComputePathToPose_SendGoal_Response(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = vox_nav_msgs__action__ComputePathToPose_GetResult_Request;
    is_plain =
      (
...
static size_t _ComputePathToPose_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vox_nav_msgs__action__ComputePathToPose_GetResult_Request(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = vox_nav_msgs__action__ComputePathToPose_GetResult_Response;
    is_plain =
      (
...
static size_t _ComputePathToPose_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vox_nav_msgs__action__ComputePathToPose_GetResult_Response(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = vox_nav_msgs__action__ComputePathToPose_FeedbackMessage;
    is_plain =
      (
...
static size_t _ComputePathToPose_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vox_nav_msgs__action__ComputePathToPose_FeedbackMessage(
    full_bounded, is_plain, 0);
