  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vox_nav_msgs::action::NavigateToPose_Goal;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = vox_nav_msgs::action::NavigateToPose_Result;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = vox_nav_msgs::action::NavigateToPose_Feedback;
    is_plain =
      (
...
// functions for vox_nav_msgs::action::NavigateToPose_Goal already declared above
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = vox_nav_msgs::action::NavigateToPose_SendGoal_Request;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = vox_nav_msgs::action::NavigateToPose_SendGoal_Response;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = vox_nav_msgs::action::NavigateToPose_GetResult_Request;
    is_plain =
      (
...
// forward declaration of message dependencies and their conversion functions
// functions for vox_nav_msgs::action::NavigateToPose_Result already declared above
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = vox_nav_msgs::action::NavigateToPose_GetResult_Response;
    is_plain =
      (
      offsetof(DataType, result) +
      last_member_size
...
// functions for vox_nav_msgs::action::NavigateToPose_Feedback already declared above
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = vox_nav_msgs::action::NavigateToPose_FeedbackMessage;
    is_plain =
      (
