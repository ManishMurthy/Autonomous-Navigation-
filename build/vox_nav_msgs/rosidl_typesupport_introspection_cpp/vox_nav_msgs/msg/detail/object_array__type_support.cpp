...
{
  const auto & item = *reinterpret_cast<const vox_nav_msgs::msg::Object *>(
    get_const_function__ObjectArray__objects(untyped_member, index));
  auto & value = *reinterpret_cast<vox_nav_msgs::msg::Object *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<vox_nav_msgs::msg::Object *>(
    get_function__ObjectArray__objects(untyped_member, index));
  const auto & value = *reinterpret_cast<const vox_nav_msgs::msg::Object *>(untyped_value);
  item = value;
}
